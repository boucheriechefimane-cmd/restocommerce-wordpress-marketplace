...
**Version de référence :** thème RestoCommerce 2.7.3  
**Auteur :** Manus AI  
...
| `safran` | Safran de médina | `#23395b` | `#fff7e7` | `#9b451f` |
| `jardin` | Jardin de saison | `#285747` | `#f2f6eb` | `#8c3b2b` |
| `nuit` | Service du soir | `#f7f3eb` | `#1f2b2b` | `#d99055` |

Le contrôle automatisé de la palette vérifie les couples nominaux de texte et action à un ratio minimal de **4,5:1**. Toute future palette doit être ajoutée à ce contrôle avant sa publication.
