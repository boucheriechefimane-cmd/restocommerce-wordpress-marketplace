  ...
  const storeMenu = qs('[data-rc-store-menu]');
	...
	const quickView = qs('[data-rc-quick-view]'); const quickContent = qs('[data-rc-quick-view-content]');
		const updateQuickConfigurator = (form) => {
			const variationId = qs('[data-rc-variation-id]', form); const price = qs('[data-rc-quick-price]', form); const submit = qs('[data-rc-quick-submit]', form); const sets = qsa('[data-rc-option-set]:not([data-rc-extra-option-set])', form); const extraSets = qsa('[data-rc-extra-option-set]', form);
